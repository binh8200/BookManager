...
public class Theloai extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        public void themtheloai(View view) {
           ...
           com.example.quanlysach.Dulieu.Theloai user = new com.example.quanlysach.Dulieu.Theloai(edMa.getText().toString(), edTen.getText().toString(),edMo.getText().toString(),edVi.getText().toString());
            try {
                if (validateForm()>0){
